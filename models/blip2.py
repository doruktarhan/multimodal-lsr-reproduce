    ...
    def forward(self, batch):
        ...
        with torch.no_grad():
            ...
            for i in range(len(batch)):
                ...
                print(f"max index: {max_indices[i]}")
                print(f"max similarity: {max_similarities[i]}")
                print(f"selected image embed size: {selected_image_embeds[i].shape}")
                print(f"text embed size: {text_embeds[i].shape}")
