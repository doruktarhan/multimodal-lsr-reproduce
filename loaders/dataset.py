...
class MSCOCOdataset:
    def __init__(self,meta_data_path: str, image_data_path : str):
    ...
    def get_image_caption_pairs(self):
        ...
        for image_data in tqdm(self.meta_data['images'], desc="Processing images and captions"):
            ...
            image_path = os.path.join(self.image_data_path, image_folder)
...
class Flickr30kdataset:
    ...
    def get_image_caption_pairs(self):
        ...
        for image_data in tqdm(self.meta_data['images'], desc="Processing images and captions"):
            ...
            #save the image path
            image_name = image_data['filename']
            image_path = os.path.join(self.image_data_path,image_name)
